    ...
    return Card(
        ...
        shape: RoundedRectangleBorder(
         ...
         child: Padding(padding: const EdgeInsets.all(18),
           child: Column( //step one root is column and row must be come
            children: [
              ...
              Row(children: [
                   ...
                   const SizedBox(width:12),
                     ...
                     Expanded(
                       child: Column( // here  inside the row text need to be arranged vertically so inside the row we need to create an column with expanded because need space between
